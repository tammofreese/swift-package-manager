...
12. Pull request will be merged by the maintainers after it tests cleanly on C and receives approval from the reviewers (one or more). The timing of merging the change may be impacted by release schedule consiferations.
